...
ADD CONSTRAINT uniquelinkedinprofile UNIQUE (linkedinprofile);

UPDATE employees
SET linkedinprofile = 'one'
WHERE employeeid = 1;

UPDATE employees
SET linkedinprofile = 'two'
WHERE employeeid = 2;

UPDATE employees
SET linkedinprofile = 'three'
WHERE employeeid = 3;

UPDATE employees
SET linkedinprofile = 'four'
WHERE employeeid = 4;

UPDATE employees
SET linkedinprofile = 'five'
WHERE employeeid = 5;

UPDATE employees
SET linkedinprofile = 'six'
WHERE employeeid = 6;

UPDATE employees
SET linkedinprofile = 'seven'
WHERE employeeid = 7;

UPDATE employees
SET linkedinprofile = 'eight'
WHERE employeeid = 8;

UPDATE employees
SET linkedinprofile = 'nine'
WHERE employeeid = 9;
...
SELECT "contactName" FROM customers ORDER BY "contactName" ASC;
...
SELECT "contactName" From customers WHERE country='France' OR country='Spain';
...
*/
SELECT productname FROM products WHERE categoryid NOT IN (1,2,3);
SELECT "contactName" FROM customers WHERE "companyName" LIKE 'A%';
...
shipperID:2
*/
INSERT INTO orders("orderID","customerID","employeeID","orderDate","requiredDate","shippedDate","shipperID")
			VALUES(11078,'VINET',5,'2025-04-23','2025-04-30','2025-04-25',2);
